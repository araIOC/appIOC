				...
				<form action="{{ route('agregarTrabajo') }}" method="POST">
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							...
							<div class=" my-2 my-lg-0">
								<div class="input-group">
									<textarea class="form-control" id="notas" placeholder="Inserte las notas adicionales..." required></textarea>
								</div>
							</div>
						</div>
					</div>
					<div class="form-row">
						<div class="form-group col-md-12 ">
							<button type="submit" class="btn btn-outline-warning btn-lg btn-block"><i class="fas fa-upload"></i> STL</button>
						</div>
					</div>
