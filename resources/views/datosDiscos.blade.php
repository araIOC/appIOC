...
<tr>
	...
	<th scope="row" data-toggle="modal" data-target=".modal-ficha-disco" data-marcad="{{$disco->marca}}" data-codigod="{{$disco->codigoD}}" data-materiald="{{$disco->material}}" data-escala="{{$disco->escala}}" data-color="{{$disco->color}}" data-fecha_alta="{{$disco->fecha_alta}}" data-altura="{{$disco->altura}}">{{$disco->codigoD}}</th>
