...
<div class="table-responsive-sm text-center" id="app">
	<table class="table table-hover table-dark consulta">
		...
		<tbody>
			...
			<tr>
				<th scope="row" data-toggle="modal" data-target=".modal-ficha-trabajo" data-nombrep="{{$trabajo->nombreP}}" data-apellidos="{{$trabajo->apellidosP}}" data-nombret="{{$trabajo->nombreT}}" data-material="{{$trabajo->material}}" data-tipotrabajo="{{$trabajo->tipo_trabajo}}" data-npiezas="{{$trabajo->n_piezas}}" data-color="{{$trabajo->color}}" data-maquina="{{$trabajo->maquina}}" data-notas="{{$trabajo->notas}}">{{$trabajo->codigoP}}</th>
				<th scope="row" data-toggle="modal" data-target=".modal-ficha-trabajo" data-nombrep="{{$trabajo->nombreP}}" data-apellidos="{{$trabajo->apellidosP}}" data-nombret="{{$trabajo->nombreT}}" data-material="{{$trabajo->material}}" data-tipotrabajo="{{$trabajo->tipo_trabajo}}" data-npiezas="{{$trabajo->n_piezas}}" data-color="{{$trabajo->color}}" data-maquina="{{$trabajo->maquina}}" data-notas="{{$trabajo->notas}}">{{$trabajo->apellidosP}}, {{$trabajo->nombreP}}</th>
				<td data-toggle="modal" data-target=".modal-ficha-trabajo" data-nombrep="{{$trabajo->nombreP}}" data-apellidos="{{$trabajo->apellidosP}}" data-nombret="{{$trabajo->nombreT}}" data-material="{{$trabajo->material}}" data-tipotrabajo="{{$trabajo->tipo_trabajo}}" data-npiezas="{{$trabajo->n_piezas}}" data-color="{{$trabajo->color}}" data-maquina="{{$trabajo->maquina}}" data-notas="{{$trabajo->notas}}">{{$trabajo->tipo_trabajo}}</td>
				<td>
